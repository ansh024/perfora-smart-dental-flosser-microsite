...
- **16 sections:** header → hero → buy/listing (single-product card + free-gift offer + Add to Cart / Buy It Now) → trust strip → benefit tiles → vs-string-floss comparison → modes & nozzles → mid CTA → how-to-use → what's-inside → who-it's-for → expert/trust → UGC placeholder → reviews → FAQ → final CTA
